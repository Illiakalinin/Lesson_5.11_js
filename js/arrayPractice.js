...
const makeYear2018Phones = phones.filter(filter2018Phone);
...
// function getNfcPhones(phone) {
//   return phone.isNfc;
// }

// const nfcPhones = phones.filter(getNfcPhones);
...
const arrApple2016 = phones.filter(
  (item) => item.makeYear === 2018 && item.brand === "IPhone"
);
